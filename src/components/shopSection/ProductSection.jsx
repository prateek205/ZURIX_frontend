        ...
        return (
          ...
          >
            <div className="relative overflow-hidden w-[100%] h-96 rounded-md flex items-center justify-center">
              ...
              >
                <LuEye className="text-2xl w-7 h-7 rounded-full bg-white" />
                <CiHeart className="text-sm w-7 h-7 rounded-full bg-white" />
              </button>

              <button
                className={`absolute bottom-4 left-1/2 -translate-x-1/2 w-[90%] py-3 bg-black text-white rounded-full font-medium transition-all duration-300 hover:bg-orange-600 hover:text-white ${
                  isHovered
                    ? "opacity-100 translate-y-0"
